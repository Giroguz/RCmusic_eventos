...
export function Brand({ compact = false }) {
  ...
  return (
    <div className="flex items-center gap-3">
      <div className="neon-orb grid h-12 w-12 shrink-0 place-items-center overflow-hidden rounded-2xl bg-white p-1 shadow-glow">
        <img src="/rc-music-logo.jpg" alt="R&C music" className="h-full w-full rounded-xl object-contain" />
      </div>
