...
export default function DjApp({ onExit, session }) {
  ...
  useEffect(() => subscribeToEventPresence(activeEvent?.id, 'dj', setOnlineCount), [activeEvent?.id])
  useEffect(() => {
