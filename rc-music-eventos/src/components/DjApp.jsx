...
export default function DjApp({ onExit, session = getStoredDjSession() }) {
  ...
  async function createEvent(e) {
    ...
    try {
      ...
      if (supabaseEnabled && form.tipsRequired) await updateDjEventTipSettings(event.id, true, session?.token)
      const eventWithOptions = { ...event, qrImage: form.qrImage || event.qrImage || '', tipsRequired: Boolean(form.tipsRequired) }
