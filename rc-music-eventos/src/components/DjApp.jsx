...
import { createDjEvent, getDjAccess, getDjEventQr, getDjEvents, setRequestStatus, signOutDj, supabaseEnabled, updateDjEventInfo, updateDjEventQr, updateDjEventTipSettings } from '../lib/supabase'
...
function DjRequestRow({ request, onStatus, onPreview, onProof, t }) {
