...
import { getStoredDjSession, getSubscriptionPlanPrices, getSubscriptionQr, getSubscriptionYapeNumber, sendEmailVerificationLink, signInDj, startDjTrial, submitSubscriptionProof, supabase, supabaseEnabled } from '../lib/supabase'
...
export default function DjLogin({ onLogin, onBack }) {
  ...
  async function submit(e) {
    ...
    try {
      ...
      setError(err?.message === 'SUPABASE_REQUIRED' ? t('supabaseRequired') : t('loginError'))
    }
  }
